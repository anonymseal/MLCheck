...
trojaned_model_arch1 = ['TrojanedModel/dnn_model_MNIST_ARCH1_1K_EPOCH1_C4_T1', 'TrojanedModel/dnn_model_MNIST_ARCH1_1K_EPOCH1_C5_T1',
                  'TrojanedModel/dnn_model_MNIST_ARCH1_1K_EPOCH1_C4_T2', 'TrojanedModel/dnn_model_MNIST_ARCH1_1K_EPOCH1_C5_T2',
                  'TrojanedModel/dnn_model_MNIST_ARCH1_1K_EPOCH1_C4_T3', 'TrojanedModel/dnn_model_MNIST_ARCH1_1K_EPOCH1_C5_T3']

white_box = ['Decision tree', 'DNN']
cont = 0
f = open('Output/trojan_attack_results_table7.txt', 'w')
t = []
...
model = Net1()
trojaned_model_arch2 = ['TrojanedModel/dnn_model_MNIST_ARCH2_1K_EPOCH1_C4_T1', 'TrojanedModel/dnn_model_MNIST_ARCH2_1K_EPOCH1_C5_T1',
                  'TrojanedModel/dnn_model_MNIST_ARCH2_1K_EPOCH1_C4_T2', 'TrojanedModel/dnn_model_MNIST_ARCH2_1K_EPOCH1_C5_T2',
                  'TrojanedModel/dnn_model_MNIST_ARCH2_1K_EPOCH1_C4_T3', 'TrojanedModel/dnn_model_MNIST_ARCH2_1K_EPOCH1_C5_T3']
cont = 0
t = []
f.write('\n \n §§§§----Results of NN2 is -----§§§§\n \n')
